...
ALT_T(KC_TAB),  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                               KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_ESC,
   KC_LCTL,     KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                               KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
   KC_LSFT,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, _______,             _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                                        TL_UPPR, KC_LGUI, KC_LSFT,        LT(_LOWER, KC_ENT),  KC_SPC,    TL_UPPR
  ),
  ...
  [_LOWER] = LAYOUT(
     ...
     _______, _______, KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC,                               KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSLS, KC_PIPE,
     _______, _______, KC_LCBR, KC_RCBR, KC_LT  , KC_GT  , _______,             _______, KC_UNDS, KC_EQL,  KC_MINS, KC_PLUS, QK_MAKE, QK_BOOT,
    ...
    [_RAISE] = LAYOUT(
     ...
     _______,  KC_MPRV, KC_MNXT, KC_VOLU, _______, _______,                            _______,    KC_4,    KC_5,    KC_6,    KC_0, _______,
     _______,  KC_MSTP, KC_MPLY, KC_VOLD, _______, _______, _______,         _______,  _______,    KC_1,    KC_2,    KC_3,    KC_0, _______,
                                         _______,  _______, _______,         _______,  _______, _______
    )
};
